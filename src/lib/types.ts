...
export const SkillSchema = z.object({
  ...
  // Enhanced Metadata
  // Metadata labels evolved across the large historical library. Keep these
  // tolerant so a harmless editorial label can never invalidate every skill.
  ...
  creativeVsAnalytical: z.string().optional(),
