...
relatedSkills: ["customer-experience", "communication", "relationship-building"]
relatedCareers: ["customer-success-manager", "customer-experience-manager", "account-manager"]
relatedIndustries: ["technology", "retail", "consulting"]
readTime: 4
featured: false
