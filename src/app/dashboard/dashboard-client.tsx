...
export function DashboardClient({ skills, careers }: DashboardClientProps) {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      if (profileResult.data) {
        ...
        // Filter saved items
        const userSavedSkills = skills.filter(skill => 
          profileResult.data?.saved_skills?.includes(skill.id)
        )
        const userSavedCareers = careers.filter(career => 
        ...
        const recs = generateRecommendations(profileResult.data, skills, careers)
